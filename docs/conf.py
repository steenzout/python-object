# -*- coding: utf-8 -*-
#
# steenzout.object package documentation build configuration file.
#
...
from steenzout.object import __version__
...
#
html_theme_options = {
    u'description': u'steenzout.object package.',
    u'fixed_sidebar': True,
    u'github_button': True,
    u'github_repo': u'python-steenzout-object',
...
htmlhelp_basename = 'py_steenzout_object'
...
latex_documents = [(
    master_doc,
    'py_steenzout_object.tex',
    u'steenzout.object documentation',
    author,
    'manual'
)]
...
man_pages = [(
    master_doc,
    'py_steenzout_object',
    'steenzout.object documentation',
    [author],
    1
)]
